...
exports.messages = {
    en: {
        ...
        "OTP-FAILED-TO-SEND": "Failed to send one time password. Please try again later.",
        ...
        'BANK-UPDATE-FAILED': "Ooops, Failed to update your bank account. Please try again later.",
        'DEFAULT-CARD-UPDATE-SUCCESS': "Your default card updated successfully.",
        'NEW-BOOKING-REQUEST': "You have a new booking request.",
        'BOOKING-ACCEPTED': "Great news! Your booking request was accepted.",
        'BOOKING-CANCELLED': "Your booking has been cancelled.",
        'NEW-MESSAGE-RECEIVED': "You have a new message.",
